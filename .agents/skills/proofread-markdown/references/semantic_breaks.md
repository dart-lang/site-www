...
- **Punctuation first**: Break lines after periods, commas, colons, and semicolons.
...
```markdown
This is a very long sentence that is wrapped at exactly eighty characters without
considering the meaning of the words or the structure of the sentence.
```
