...
RUN set -eu; \
    case "$(dpkg --print-architecture)_${DART_CHANNEL}" in \
      ...
      arm64_beta) \
        ...
        SDK_ARCH="arm64";; \
      amd64_dev) \
        DART_SHA256="32186cfb7e895186adaab11a1ac4d0ed39d34c824f07f2ef6fe3d20366a88c4b"; \
        SDK_ARCH="x64";; \
      arm64_dev) \
        DART_SHA256="815e5bd2a51b643fc306c9d03164452770d0ade64b561661d4d41ee5e635d5b9"; \
        SDK_ARCH="arm64";; \
    esac; \
