...
RUN set -eu; \
    case "$(dpkg --print-architecture)_${DART_CHANNEL}" in \
      ...
      arm64_beta) \
        ...
        SDK_ARCH="arm64";; \
      amd64_dev) \
        DART_SHA256="17bd5d710cf3347b63ada084d2097b990de70f7db82e3ff82707dfb498fde2b9"; \
        SDK_ARCH="x64";; \
      arm64_dev) \
        DART_SHA256="babb7a240df80c543ab8b4aa5117508468632450e4f4d87c484cdf599468352a"; \
        SDK_ARCH="arm64";; \
    esac; \
