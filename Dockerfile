...
RUN set -eu; \
    case "$(dpkg --print-architecture)_${DART_CHANNEL}" in \
      ...
      arm64_beta) \
        ...
        SDK_ARCH="arm64";; \
      amd64_dev) \
        DART_SHA256="3c15f38a624123afebcb74d9ca604b4bb2a127a22e6f9317051a064056124be2"; \
        SDK_ARCH="x64";; \
      arm64_dev) \
        DART_SHA256="0ce72e97e2e935a2f319d6ebcf0353ac20f9f0d7b8080e5f413cdb9da7e98b59"; \
        SDK_ARCH="arm64";; \
    esac; \
