...
function dart_precompiled($collectedClasses) {
  ...
  function getUrl_closure(onSuccess_0, request_1) {
    this.onSuccess_0 = onSuccess_0;
    this.request_1 = request_1;
  }
  getUrl_closure.builtin$cls = "getUrl_closure";
  if (!"name" in getUrl_closure)
    getUrl_closure.name = "getUrl_closure";
  $desc = $collectedClasses.getUrl_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getUrl_closure.prototype = $desc;
  function main_closure(lang_0) {
    this.lang_0 = lang_0;
  }
