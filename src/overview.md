...
platform](/platforms) for app frameworks.
...
Dart offers [sound null safety](/null-safety), meaning that
...
* [Explore Dart in the browser](https://dartpad.dev/) through DartPad, a
  web-based execution environment for Dart code.
* [Take a tour of the Dart
  language](/guides/language/language-tour), which shows you how to
...
* [Work through extensive online
  ...
  from Dart experts.
* [Explore the API documentation](https://api.dart.dev/) that describes the
  Dart core libraries.
