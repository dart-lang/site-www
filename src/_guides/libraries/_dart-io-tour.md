...
<?code-excerpt "misc/lib/library_tour/io/http_server.dart" replace="/Future\<void\u{003E}/void/g; /\b_//g"?>
```dart
void main() async {
...
<?code-excerpt "misc/test/library_tour/io_test.dart (client)" replace="/Future\<void\u{003E}/void/g"?>
```dart
void main() async {
