...
<?code-excerpt "html/test/html_test.dart (getString)" plaster="none" replace="/await.*;/[!$&!]/g; /Future\<void\u{003E}/void/g"?>
...
<?code-excerpt "html/test/html_test.dart (request)" replace="/Future\<void\u{003E}/void/g; /await.*;/[!$&!]/g"?>
```dart
void main() async {
