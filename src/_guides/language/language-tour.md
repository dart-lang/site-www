...
<?code-excerpt "tours/test/language_tour/basic_test.dart"?>
{% prettify dart %}
// Define a function.
...
<?code-excerpt "tours/lib/language_tour/variables.dart (var-decl)"?>
{% prettify dart %}
var name = 'Bob';
{% endprettify %}
...
<?code-excerpt "tours/test/language_tour/variables_test.dart (var-null-init)"?>
{% prettify dart %}
int lineCount;
...
<?code-excerpt "tours/lib/language_tour/variables.dart (static-types)"?>
{% prettify dart %}
String name = 'Bob';
{% endprettify %}
...
<?code-excerpt "tours/lib/language_tour/variables.dart (final)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/variables.dart (const)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/variables.dart (const-vs-final)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (integer-literals)"?>
{% prettify dart %}
int x = 1;
int hex = 0xDEADBEEF;
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (double-literals)"?>
{% prettify dart %}
double y = 1.1;
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (number-conversion)"?>
{% prettify dart %}
// String -> int
var one = int.parse('1');
assert(one == 1);
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (bit-shifting)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (const-num)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (quoting)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (string-interpolation)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (adjacent-string-literals)"?>
{% prettify dart %}
var s1 = 'String '
    'concatenation'
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (triple-quotes)"?>
{% prettify dart %}
var s1 = '''
You can create
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (raw-strings)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (string-literals)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (strictly-boolean)"?>
{% prettify dart %}
var name = 'Bob';
if (name) {
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (if-one)"?>
{% prettify dart %}
if (1) {
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (no-truthy)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (list-literal)"?>
{% prettify dart %}
var list = [1, 2, 3];
{% endprettify %}
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (list-indexing)"?>
{% prettify dart %}
var list = [1, 2, 3];
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (const-list)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (map-literal)"?>
{% prettify dart %}
var gifts = {
  // Key:    Value
  'first': 'partridge',
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (map-constructor)"?>
{% prettify dart %}
var gifts = new Map();
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (map-add-item)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (map-retrieve-item)"?>
{% prettify dart %}
var gifts = {'first': 'partridge'};
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (map-missing-key)"?>
{% prettify dart %}
var gifts = {'first': 'partridge'};
...
<?code-excerpt "tours/test/language_tour/built_in_types_test.dart (map-length)"?>
{% prettify dart %}
var gifts = {'first': 'partridge'};
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (const-map)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (runes)"?>
{% prettify dart %}
void main() {
...
<?code-excerpt "tours/lib/language_tour/built_in_types.dart (symbols)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (function)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (function-omitting-types)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (function-shorthand)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (use-named-parameters)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (specify-named-parameters)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (optional-positional-parameters)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (call-without-optional-param)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (call-with-optional-param)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (named-parameter-default-values)"?>
{% prettify dart %}
/// Sets the [bold] and [hidden] flags ...
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (optional-positional-param-default)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (list-map-default-function-param)"?>
{% prettify dart %}
void doStuff(
...
<?code-excerpt "tours/test/language_tour/browser_test.dart (simple-web-main-function)"?>
{% prettify dart %}
void main() {
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (main-args)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/functions.dart (function-as-param)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (function-as-var)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (anonymous-function)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (anon-func)"?>
{% prettify dart %}
list.forEach(
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (nested-functions)"?>
{% prettify dart %}
bool topLevel = true;
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (function-closure)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/function_equality.dart"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/functions_test.dart (implicit-return-null)"?>
{% prettify dart %}
foo() {}
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (expressions)" replace="/,//g"?>
{% prettify dart %}
a++
a + b
a = b
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (precedence)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (arithmetic)"?>
{% prettify dart %}
assert(2 + 3 == 5);
assert(2 - 3 == -1);
assert(2 * 3 == 6);
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (increment-decrement)"?>
{% prettify dart %}
var a, b;
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (relational)"?>
{% prettify dart %}
assert(2 == 2);
assert(2 != 3);
assert(3 > 2);
...
<?code-excerpt "tours/lib/language_tour/classes/employee.dart (emp is Person)"?>
{% prettify dart %}
if (emp is Person) {
  // Type check
  emp.firstName = 'Bob';
...
<?code-excerpt "tours/lib/language_tour/classes/employee.dart (emp as Person)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (assignment)"?>
{% prettify dart %}
// Assign value to a
a = value;
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (assignment-gist-main-body)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (op-assign)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/operators.dart (op-logical)"?>
{% prettify dart %}
if (!done && (col == 0 || col == 3)) {
  // ...Do something...
}
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (op-bitwise)"?>
{% prettify dart %}
final value = 0x22;
final bitmask = 0x0f;
...
<?code-excerpt "tours/lib/language_tour/operators.dart (if-then-else-operator)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (if-null)" replace="/\d//g"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/operators_test.dart (if-null-alt)" replace="/\d//g"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/browser_test.dart (cascade-operator)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/browser_test.dart (cascade-operator-example-expanded)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/operators.dart (nested-cascades)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/operators.dart (cannot-cascade-on-void)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (if-else)"?>
{% prettify dart %}
if (isRaining()) {
  you.bringRainCoat();
} else if (isSnowing()) {
...
<?code-excerpt "tours/test/language_tour/control_flow_test.dart (for)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/control_flow_test.dart (for-and-closures)"?>
{% prettify dart %}
var callbacks = [];
for (var i = 0; i < 2; i++) {
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (forEach)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/control_flow_test.dart (collection)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (while)"?>
{% prettify dart %}
while (!isDone()) {
  doSomething();
}
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (do-while)"?>
{% prettify dart %}
do {
  printLine();
} while (!atEndOfPage());
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (while-break)"?>
{% prettify dart %}
while (true) {
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (for-continue)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (where)"?>
{% prettify dart %}
candidates
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (switch)"?>
{% prettify dart %}
var command = 'OPEN';
switch (command) {
  case 'CLOSED':
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (switch-break-omitted)"?>
{% prettify dart %}
var command = 'OPEN';
switch (command) {
  case 'OPEN':
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (switch-empty-case)"?>
{% prettify dart %}
var command = 'CLOSED';
switch (command) {
...
<?code-excerpt "tours/lib/language_tour/control_flow.dart (switch-continue)"?>
{% prettify dart %}
var command = 'CLOSED';
switch (command) {
  case 'CLOSED':
...
<?code-excerpt "tours/test/language_tour/control_flow_test.dart (assert)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/control_flow_test.dart (assert-with-message)"?>
{% prettify dart %}
assert(urlString.startsWith('https'),
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (throw-FormatException)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (out-of-llamas)"?>
{% prettify dart %}
throw 'Out of llamas!';
{% endprettify %}
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (throw-is-an-expression)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (try)"?>
{% prettify dart %}
try {
  breedMoreLlamas();
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (try-catch)"?>
{% prettify dart %}
try {
  breedMoreLlamas();
} on OutOfLlamasException {
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (try-catch-2)" replace="/\(e.*?\)/[!$&!]/g"?>
{% prettify dart %}
try {
  // ···
} on Exception catch [!(e)!] {
...
<?code-excerpt "tours/test/language_tour/exceptions_test.dart (rethrow)" replace="/rethrow;/[!$&!]/g"?>
{% prettify dart %}
final foo = '';
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (finally)"?>
{% prettify dart %}
try {
  breedMoreLlamas();
} finally {
...
<?code-excerpt "tours/lib/language_tour/exceptions.dart (try-catch-finally)"?>
{% prettify dart %}
try {
  breedMoreLlamas();
} catch (e) {
...
<?code-excerpt "tours/test/language_tour/classes_test.dart (object-creation)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/classes_test.dart (object-members)"?>
{% prettify dart %}
var p = new Point(2, 2);
...
<?code-excerpt "tours/test/language_tour/classes_test.dart (safe-member-access)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/classes_test.dart (const)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/classes_test.dart (identical)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/classes_test.dart (runtimeType)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/point_with_main.dart (class)"?>
{% prettify dart %}
class Point {
...
<?code-excerpt "tours/lib/language_tour/classes/point_with_main.dart (class+main)" replace="/(num .*?;).*/$1/g"?>
{% prettify dart %}
class Point {
  num x;
  num y;
...
<?code-excerpt "tours/lib/language_tour/classes/point_alt.dart (constructor-long-way)"?>
{% prettify dart %}
class Point {
  num x, y;
...
<?code-excerpt "tours/lib/language_tour/classes/point.dart (constructor-initializer)"?>
{% prettify dart %}
class Point {
  num x, y;
...
<?code-excerpt "tours/lib/language_tour/classes/point.dart (named-constructor)" replace="/Point\.\S*/[!$&!]/g"?>
{% prettify dart %}
class Point {
  num x, y;
...
<?code-excerpt "tours/lib/language_tour/classes/employee.dart"?>
{% prettify dart %}
class Person {
  String firstName;
...
<?code-excerpt "tours/lib/language_tour/classes/employee.dart (method-then-constructor)"?>
{% prettify dart %}
class Employee extends Person {
...
<?code-excerpt "tours/lib/language_tour/classes/point_alt.dart (initializer-list)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/point_with_distance_field.dart"?>
{% prettify dart %}
import 'dart:math';
...
<?code-excerpt "tours/lib/language_tour/classes/point_redirecting.dart"?>
{% prettify dart %}
class Point {
  num x, y;
...
<?code-excerpt "tours/lib/language_tour/classes/immutable_point.dart"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/logger.dart"?>
{% prettify dart %}
class Logger {
  final String name;
  bool mute = false;
...
<?code-excerpt "tours/lib/language_tour/classes/logger.dart (logger)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/point.dart (class-with-distanceTo)"?>
{% prettify dart %}
import 'dart:math';
...
<?code-excerpt "tours/lib/language_tour/classes/rectangle.dart"?>
{% prettify dart %}
class Rectangle {
...
<?code-excerpt "tours/lib/language_tour/classes/doer.dart"?>
{% prettify dart %}
abstract class Doer {
...
<?code-excerpt "tours/lib/language_tour/classes/vector.dart"?>
{% prettify dart %}
class Vector {
  final int x, y;
...
<?code-excerpt "tours/lib/language_tour/classes/misc.dart (abstract)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/misc.dart (extends)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/impostor.dart"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/misc.dart (point_interfaces)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/extends.dart" replace="/extends|super/[!$&!]/g"?>
{% prettify dart %}
class Television {
  void turnOn() {
    _illuminateDisplay();
...
<?code-excerpt "tours/lib/language_tour/metadata/television.dart (override)" replace="/@override/[!$&!]/g"?>
{% prettify dart %}
class SmartTelevision extends Television {
  [!@override!]
  void turnOn() {
...
<?code-excerpt "tours/lib/language_tour/classes/no_such_method.dart" replace="/noSuchMethod(?!,)/[!$&!]/g"?>
{% prettify dart %}
class A {
...
<?code-excerpt "tours/lib/language_tour/classes/proxy.dart" replace="/@proxy/[!$&!]/g"?>
{% prettify dart %}
[!@proxy!]
class A {
  @override
...
<?code-excerpt "tours/lib/language_tour/classes/proxy_alt.dart" replace="/implements[^{]+/[!$&!]/g"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/enum.dart (enum)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/enum.dart (index)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/enum.dart (values)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/enum.dart (switch)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/orchestra.dart (Musician and Maestro)" replace="/(with.*) \{/[!$1!] {/g"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/orchestra.dart (Musical)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/classes/misc.dart (static-field)"?>
{% prettify dart %}
class Queue {
...
<?code-excerpt "tours/lib/language_tour/classes/point_with_distance_method.dart"?>
{% prettify dart %}
import 'dart:math';
...
<?code-excerpt "tours/test/language_tour/generics_test.dart (why-generics)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/generics/cache.dart (ObjectCache)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/generics/cache.dart (StringCache)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/generics/cache.dart (Cache)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/generics/misc.dart (collection-literals)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/generics_test.dart (constructor-1)"?>
{% prettify dart %}
var names = new List<String>();
names.addAll(['Seth', 'Kathy', 'Lars']);
...
<?code-excerpt "tours/test/language_tour/generics_test.dart (constructor-2)"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/generics_test.dart (generic-collections)"?>
{% prettify dart %}
var names = new List<String>();
names.addAll(['Seth', 'Kathy', 'Lars']);
...
<?code-excerpt "tours/lib/language_tour/generics/base_class.dart" replace="/extends SomeBaseClass(?=. \{)/[!$&!]/g"?>
{% prettify dart %}
...
<?code-excerpt "tours/test/language_tour/generics_test.dart (method)" replace="/<T.(?=\()|T/[!$&!]/g"?>
{% prettify dart %}
[!T!] first[!<T>!](List<[!T!]> ts) {
...
<?code-excerpt "tours/test/language_tour/browser_test.dart (dart-html-import)"?>
{% prettify dart %}
import 'dart:html';
{% endprettify %}
...
<?code-excerpt "tours/test/language_tour/browser_test.dart (package-import)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/libraries/import_as.dart" replace="/(lib\d)\.dart/package:$1\/$&/g"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/libraries/show_hide.dart" replace="/(lib\d)\.dart/package:$1\/$&/g"?>
{% prettify dart %}
// Import only foo.
...
<?code-excerpt "tours/lib/language_tour/libraries/greeter.dart (import)" replace="/hello\.dart/package:greetings\/$&/g"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/libraries/greeter.dart (loadLibrary)"?>
{% prettify dart %}
Future greet() async {
...
<?code-excerpt "tours/lib/language_tour/async.dart (await-lookUpVersion)"?>
{% prettify dart %}
await lookUpVersion();
{% endprettify %}
...
<?code-excerpt "tours/lib/language_tour/async.dart (checkVersion)" replace="/async|await/[!$&!]/g"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/async.dart (try-catch)"?>
{% prettify dart %}
try {
...
<?code-excerpt "tours/lib/language_tour/async.dart (sync-lookUpVersion)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/async.dart (async-lookUpVersion)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/async.dart (repeated-await)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/async.dart (main)"?>
{% prettify dart %}
Future main() async {
  checkVersion();
...
<?code-excerpt "tours/lib/language_tour/async.dart (number_thinker)"?>
{% prettify dart %}
Future main() async {
  // ...
...
<?code-excerpt "tours/lib/language_tour/callable_classes.dart"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/typedefs/sorted_collection_1.dart"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/typedefs/sorted_collection_2.dart"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/typedefs/misc.dart (compare)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/typedefs/misc.dart (Function)"?>
{% prettify dart %}
...
<?code-excerpt "tours/lib/language_tour/metadata/television.dart (deprecated)" replace="/@deprecated/[!$&!]/g"?>
{% prettify dart %}
class Television {
...
<?code-excerpt "tours/lib/language_tour/metadata/todo.dart"?>
{% prettify dart %}
library todo;
...
<?code-excerpt "tours/lib/language_tour/metadata/misc.dart"?>
{% prettify dart %}
import 'todo.dart';
...
<?code-excerpt "tours/lib/language_tour/comments.dart (single-line-comments)"?>
{% prettify dart %}
void main() {
...
<?code-excerpt "tours/lib/language_tour/comments.dart (multi-line-comments)"?>
{% prettify dart %}
void main() {
  /*
...
<?code-excerpt "tours/lib/language_tour/comments.dart (doc-comments)"?>
{% prettify dart %}
