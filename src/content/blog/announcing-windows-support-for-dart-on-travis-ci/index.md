...
<DashImage src="images/1Zh0PvesZNUKCljlerYe4Sg.png" alt="Announcement graphic for Windows support for Dart on Travis CI, showing successful build jobs for Linux, macOS, and Windows." />
...
<DashImage src="images/0wegLWjqUZkUfufxl.png" alt="Travis CI test matrix running on Linux, macOS, and Windows." caption="Travis CI test matrix run on Linux, MacOS, and Windows" />
