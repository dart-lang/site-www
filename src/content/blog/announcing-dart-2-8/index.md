...
<DashImage src="images/1JrrSSD8LCLMkAUIV8RJlkw.png" alt="Dart 2.8 release banner highlighting the pub outdated tool and pub tool performance." caption="Announcing Dart 2.8: Faster package tools, new tool for ensuring dependencies never go stale" />
...
<DashImage src="images/1av2bRfpUdU2Fk4s8xRPnhA.gif" alt="A terminal animation recording showing the output of the pub outdated command." />
