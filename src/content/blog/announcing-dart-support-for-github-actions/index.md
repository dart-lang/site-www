...
<DashImage src="images/15E8_aBC9TBl9oBUwN3jAJw.png" alt="GitHub Marketplace page for the Setup Dart SDK action." />
...
<DashImage src="images/0IA24lXOJ0Zy1uwXF.png" alt="The Actions tab in the GitHub web UI." />


Just below the the introduction, you should see a section suggesting a workflow for a Dart repository:

<DashImage src="images/0tz1_DLk4qI1MpI4z.png" alt="A suggested Dart workflow in the GitHub Actions UI." />
...
<DashImage src="images/0Wm1ERed37w-oyoDq.png" alt="Nine separately run test jobs resulting from the GitHub Actions matrix." />
