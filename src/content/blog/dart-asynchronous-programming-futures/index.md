...
<DashImage src="images/1G4044qvxp8yBjmGVHVLEyw.png" alt="Dart code stores the result of http.get('http://example.com') in myFuture." caption="Many asynchronous Dart APIs return futures." />
...
<DashImage src="images/1UD63BMoIBmzoA6jo3LjCCg.png" alt="Flowchart with Uncompleted branching to Completed with data and Completed with error." caption="The 3 states of a future" />
...
<DashImage src="images/0xlxALlxjazVifRep.png" alt="Queued events moving toward a gear with circular arrows representing the Dart event loop." caption="The Dart event loop processes one event at a time." />
