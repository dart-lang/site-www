...
We continue our work to make [AOT-compiled code](https://hackernoon.com/why-flutter-uses-dart-dd635a054ebf), such as Flutter apps, even faster. In Dart 2.1, [we reduced overhead of type checks]({{site.dart-blog}}/announcing-dart-2-1-improved-performance-usability), greatly reducing the cost of the type checks for both AOT-compiled code and for code run in the VM with JIT (just-in-time) compilation.
