...
<DashImage src="images/1tzmsHv4_tAl7Nil6XZaANw.png" alt="The logos for Google Summer of Code and Dart side-by-side." />
...
<DashImage src="images/187NMdHXboVklByFDhR9d2Q.png" alt="Diagram showing an incorrect dependency constraint caused by improper versioning of package:foo." caption="An incorrect dependency constraint caused by improper versioning of `package:foo`" />
