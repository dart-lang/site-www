...
<DashImage src="images/0pojZOcfCeFztkEzK.png" alt="Dart 3.6 release banner with the Dart logo, a bullseye icon, and blue vertical bars." caption="Dart 3.6" />
...
<DashImage src="images/0KJoC5ioNl7lXms0P.png" alt="The new download count and sparkline graph displayed on pub.dev." caption="A screenshot highlighting the new download count and sparkline graph on pub.dev" />
