...
<DashImage src="images/1VTEwPWrLp7D0teLcI-HALw.webp" alt="Pub.dev args package card with a Null safety badge and text telling Dart package authors to migrate to null safety." />


Today we’re announcing a new beta release of Dart. This beta represents a new level of stability and confidence in the new [sound null safety]({{site.dart-blog}}/why-nullable-types) type system, which we’ve been working on for over a year. The updated Dart beta (2.12.0–259.9.beta) is available on [dart.dev](https://dart.dev/get-dart) and is also included in the [beta channel of Flutter](https://flutter.dev/docs/get-started/install). We don’t anticipate any more breaking changes between now and the stable release of this feature.
...
<DashImage src="images/0GcE_GbN_IrB_dLtq.webp" alt="Pub.dev args package page with a 1.6.0 stable version and a 2.0.0 preview version." caption="*pub.dev showing the args package with a 1.6.0 stable version and a 2.0.0 preview version*" />
