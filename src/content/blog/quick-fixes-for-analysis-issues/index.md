...
A *quick fix* is an automated edit targeted at fixing the issue reported by a specific diagnostic. In the [Dart diagnostic messages]({{site.dart-blog}}/dart-diagnostic-messages) article, we looked at the following code:
