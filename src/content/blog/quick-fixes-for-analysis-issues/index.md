...
<DashImage src="images/0PHnbrlzf5BzJAyp8.png" alt="Code snippet showing an error with quick fix suggestions." />
...
<DashImage src="images/0kv6ByFzA_oUH-1J-.png" alt="Dart code after applying a quick fix, replacing values.length with values?.length inside a null check." />
...
<DashImage src="images/0SSy3gV3OrvEOjqyY.png" alt="IntelliJ IDEA context actions menu offering to replace '.' with '?.' or add a null check for values.length." />
...
<DashImage src="images/09fUhfo7YYZeSkbwJ.png" alt="IntelliJ IDEA hover text explaining that values.length can't be unconditionally accessed and offering the ?. quick fix." />


If that’s not enough, you can also invoke the available fixes from the context menu in the Dart Analysis view:

<DashImage src="images/0KOFAwRRqF1nxP-X4.png" alt="Dart Analysis context menu in IntelliJ IDEA offering quick fixes for the nullable values.length diagnostic." />
...
<DashImage src="images/06MrUQEB2aHocDDXS.png" alt="Visual Studio Code actions menu offering to replace '.' with '?.' or add a null check for values.length." />
...
<DashImage src="images/0t9j1bNBN9t_H_vGm.png" alt="An IDE showing the Problems panel in Visual Studio Code with a quick fix menu open offering to replace '.' with '?.'." />


You can also invoke them from the context menu in the Problems panel:

<DashImage src="images/0rD7c_L6FPLusv6lm.png" alt="The Visual Studio Code context menu for a problem entry showing 'Quick Fix' and 'Copy' options." />
...
<DashImage src="images/0JudcB_TM8lvc32Ld.png" alt="An IDE showing the code 'await file.readAsString();' with a red squiggly line under 'await' and an error about using await in a non-async function." />
...
<DashImage src="images/0sgdKZfY_KVOLiIJU.png" alt="An IDE showing the quick fix menu with 'Add async modifier' highlighted to fix the 'await' error." />
...
<DashImage src="images/0WW-9wW23CnKxWZO2.png" alt="An IDE showing the code after the quick fix, now with the 'async' keyword and the return type updated to a Future of String." />
