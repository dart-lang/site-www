...
<DashImage src="images/1cAi4WO4IfN5Sp6WE6Ex8Ig.png" alt="Code snippet demonstrating how to write books to a Realm data store using Dart." caption="Writing books to a Realm data store using Dart" />
