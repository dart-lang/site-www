...
<DashImage src="images/04btaxCBW8Btx71RM.png" alt="Dart DevTools CPU Profiler showing StringBase plus taking most of the CPU time." />
...
<DashImage src="images/0zxcsj31nCh14rLYa.png" alt="The Group by dropdown in the CPU Profiler with User Tag selected." />


When we expand the **Text Matching** tag, we confirm that the `_StringBase.+` method is called in our text-matching loop:

<DashImage src="images/0ai9S8-Y8c_94rr6p.png" alt="Text Matching tag expanded in the CPU Profiler, showing the StringBase plus method call." />
...
<DashImage src="images/0dL9EpPsSbaU-Bem-.png" alt="The CPU Profiler shows time spent primarily on printing matches rather than text matching." />
