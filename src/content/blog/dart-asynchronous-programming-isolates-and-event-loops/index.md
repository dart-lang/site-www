...
<DashImage src="images/1xtjhmzoLQEmh7Od1BkroVg.png" alt="Single isolate card containing a memory grid above circular event-loop arrows." caption="An isolate has its own memory and a single thread of execution that runs an event loop." />
...
<DashImage src="images/1MnJQG2bdbcqmEwu1lSL52Q.png" alt="Two separate isolate cards, each with its own memory grid and event-loop arrows." caption="Two isolates, each with its own memory and thread of execution." />
...
<DashImage src="images/1kxDfLtL2ySN1yiY1nmcTrA.png" alt="Two isolate cards with a message marker entering the second isolate's event loop." caption="Isolates can send messages to other isolates." />
...
<DashImage src="images/1t-mHg6JrdkKCs65UvD70-Q.png" alt="Queued events moving one at a time toward a gear with circular event-loop arrows." caption="The event loop processes one event at a time." />
