...
<DashImage src="images/0lY0iF-neazyL0aE-.gif" alt="An animation of a bash terminal showing the command line interface." />
...
<DashImage src="images/0f5pvUnbesO4mGZmW.gif" alt="The kilo editor written in Dart and compiled to an executable with dart2native editing its own source code." caption="The kilo editor written in Dart and compiled to an executable with dart2native editing it’s own source code" />
