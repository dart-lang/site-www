...
<DashImage src="images/0lOBcrb2bYgKV6VYT.png" alt="An origami hummingbird in Dart's original color scheme." />
...
<DashImage src="images/1sqspbSjstPhKIsIbZBDq-Q.gif" alt="A user interacts with the Python REPL." caption="Good ol’ Python REPL" />
...
<DashImage src="images/0wtt2rUBIRxHnPUHv.jpg" alt="Person smiling while holding a banana, overlaid with the text 'You are so crazy lol'." />
...
<DashImage src="images/02PUDlyPF7rchkNmA.jpg" alt="Confused person holding their head, overlaid with the text 'What do these words mean'." />
...
<DashImage src="images/12tDjwpxSxslDUfiv8enwow.gif" alt="A user evaluates simple expressions in the Dart REPL." caption="Simple expressions: DONE" />
...
<DashImage src="images/0bgs2vFlKPkZsFbSO.jpg" alt="Person leaning forward in conversation, overlaid with the text 'That's not enough. We have to go deeper'." />


And it works \o/

<DashImage src="images/1eh9q0mNToXK0R_QiYdrylw.gif" alt="A user successfully imports custom libraries in the Dart REPL." caption="Custom imports: DONE" />
...
<DashImage src="images/1uemGA2TzYypx2RmooQfwmg.gif" alt="A user evaluates both statements and expressions in the Dart REPL." caption="Statements and expressions: DONE" />
...
<DashImage src="images/1KKIJauKlylkVMaLvhJQq9w.gif" alt="A user imports a library from another package in the Dart REPL." caption="Import any library from another package: DONE" />
...
<DashImage src="images/0Xn430bpRfeDmM9uF.jpg" alt="Grumpy Cat meme with the text 'THE END IS NEAR - GOOD'." />
...
<DashImage src="images/00_DI8nuDDB5VwIbc.jpg" alt="Closing meme about the Dart REPL proof of concept with the text 'You Deserve A Cookie'." />
