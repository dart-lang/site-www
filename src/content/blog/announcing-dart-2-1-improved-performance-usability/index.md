...
Since the [launch of Dart 2]({{site.dart-blog}}/announcing-dart-2-stable-and-the-dart-web-platform) back in August, we’ve worked on getting the whole ecosystem onto Dart 2. We switched our [dartlang.org](https://www.dartlang.org/) website over to use Dart 2 examples everywhere, and we offered [tools and documentation for migrating]({{site.dart-blog}}/getting-ready-for-dart-2-and-making-your-packages-look-great-on-the-pub-site) Dart 1.x packages. We understand that the large changes in Dart 2 involved migration work for existing Dart developers, and we’re very thankful to those who have helped us build a new foundation for the future. Our focus now shifts to taking advantage of these investments to deliver improvements to performance and productivity.
