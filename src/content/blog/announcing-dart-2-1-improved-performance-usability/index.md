...
<DashImage src="images/1xZHP-8eEl6qJCCTKXyQZ8w.png" alt="Dart 2.1 release banner listing faster tools, smaller output, compile-time type checking, int-to-double inference, and new mixin syntax." />
...
<DashImage src="images/19hItMsF9iM2BHzbuJkHNbg.png" alt="Code showing integer values passed to EdgeInsets.symmetric, with analysis errors because the API expects doubles." />
...
<DashImage src="images/1bJV4DQzBey1fc64nerTprg.png" alt="Code showing EdgeInsets.symmetric with integer values accepted for horizontal and vertical padding." />
...
<DashImage src="images/0uUIuZJgNCevxAkZQ.png" alt="Code declaring SingleTickerProviderStateMixin as a mixin on State that implements TickerProvider." />
...
<DashImage src="images/1Y_8yHDINe7LtvmyFmCqWzw.png" alt="Code snippet showing a Flutter state class extending the framework State class." />
...
<DashImage src="images/1Ym0nqsHWlTscD140Urk0xw.png" alt="IDE screenshot showing an error because MyHomePage doesn't extend StatefulWidget." />
