...
In [Quick fixes for analysis issues]({{site.dart-blog}}/quick-fixes-for-analysis-issues) we looked at support for automatically fixing individual diagnostics while editing. Sometimes even that’s too slow and you’d really like to fix multiple diagnostics all at once. Fortunately, there’s support for that too, which we cover in this article.
