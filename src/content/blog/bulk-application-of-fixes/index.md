...
<DashImage src="images/0URmNnWSjGRGOorjv.png" alt="A code snippet in Visual Studio Code showing unused import warnings." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/03QaE0FunXWpPp2Az.png" alt="A code snippet in IntelliJ IDEA showing unused import warnings." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />
...
<DashImage src="images/0p2Pf06L6A4JSX7IS.png" alt="A context menu in Visual Studio Code offering to remove all unused imports in the file." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0S4UnOqdx-h0U55jU.png" alt="A context menu in IntelliJ IDEA offering to remove all unused imports in the file." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />


Selecting the “in-file” fix does exactly what you’d expect — it removes all unused imports in the file:

<DashImage src="images/0dHw4rjdxTR0liZX8.png" alt="The code snippet in Visual Studio Code after removing unused imports." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0Wk6qnyUlNr3qN0GQ.png" alt="The code snippet in IntelliJ IDEA after removing unused imports." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />
...
<DashImage src="images/0mr1A2XnnRCaamU22.png" alt="A code editor showing multiple unused import warnings marked with blue squiggly lines." />


If you right click to open the context menu, you’ll see the following:

<DashImage src="images/03klKEJk5p40lCPbO.png" alt="The right-click context menu in Visual Studio Code with 'Source Action...' highlighted." />


If you select **Source Action…**, it opens a second menu:

<DashImage src="images/0iRZIzPrwKl7jEYNY.png" alt="The 'Source Action...' menu in Visual Studio Code displaying 'Sort Members', 'Organize Imports', and 'Fix All' options." />


Selecting **Fix All** causes fixes to be applied to all the diagnostics in the editor, producing the following:

<DashImage src="images/0FDf16dDPwfPg_dET.png" alt="The code editor after selecting 'Fix All', showing the unused imports have been successfully removed." />
...
<DashImage src="images/0Jrz3MRfYVtcXrb9C.png" alt="The Visual Studio Code command palette with 'fix' typed into the search bar, showing the 'Fix All' command." />
