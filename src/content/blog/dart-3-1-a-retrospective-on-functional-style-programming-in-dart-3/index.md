...
<DashImage src="images/1IWd8aRO__OzDkJVsjfoe2A.png" alt="A diff of a Dart 3 refactor using functional style features within Dart's internal code base." caption="Diff of a Dart 3 refactor using functional style features within Dart’s internal code base" />
...
<DashImage src="images/1qYQb8DZyeJDFD-VKEb4P6Q.png" alt="Annotated Dart pattern syntax showing an object pattern, nested object pattern, upcast, and variable pattern." caption="Annotated depiction of the syntax for a deeply nested object and variable patterns" />
