...
<DashImage src="images/0V2JRi49yUj_MkFjS.png" alt="Visual Studio Code showing the quick assist menu to extract a local variable." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0SH7NIMTeCdgyE2Uf.png" alt="IntelliJ IDEA showing the quick assist menu to extract a local variable." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />
...
<DashImage src="images/0zkIBfG56juJk2AuT.png" alt="Visual Studio Code after extracting a local variable." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0jfAvjus6m7-TCP4S.png" alt="IntelliJ IDEA after extracting a local variable." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />
...
<DashImage src="images/0hp1u0YSRQsoNMaJl.png" alt="Visual Studio Code showing the quick assist to convert an expression body to a block body." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0Ca5bRUzZ-Y4dHkw2.png" alt="IntelliJ IDEA showing the quick assist to convert an expression body to a block body." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />


Selecting “Convert to block body” rewrites the function body to look like this:

<DashImage src="images/0mU7Y97eTeCILB1sr.png" alt="Visual Studio Code after converting to a block body." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0miez1wvKHge96Ggl.png" alt="IntelliJ IDEA after converting to a block body." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />
...
<DashImage src="images/06C745jOIAaB-k0f-.png" alt="Visual Studio Code showing the quick assist to join an if statement with an outer if statement." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/09mRjNGVqm82qAeg0.png" alt="IntelliJ IDEA showing the quick assist to join an if statement with an outer if statement." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />
...
<DashImage src="images/0PGLOLXQPGGTZFTCE.png" alt="Visual Studio Code showing the quick assist to convert to using super parameters." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0pfrf--11lE_B1oTf.png" alt="IntelliJ IDEA showing the quick assist to convert to using super parameters." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />


Selecting “Convert to using super parameters” rewrites the code to look like this:

<DashImage src="images/0Lr2HLGu31CqL5JLd.png" alt="Visual Studio Code after converting to super parameters." caption="[Visual Studio Code](https://code.visualstudio.com/)" />


<DashImage src="images/0nHsQKP9Wtm1UZn6-.png" alt="IntelliJ IDEA after converting to super parameters." caption="[IntelliJ IDEA](https://www.jetbrains.com/idea/)" />
