...
A *quick assist* is an automated edit targeted at making a common change to the code. Unlike a quick fix, which we looked at in [Quick fixes for analysis issues]({{site.dart-blog}}/quick-fixes-for-analysis-issues) and [Bulk application of fixes]({{site.dart-blog}}/bulk-application-of-fixes), the presence of a quick assist isn’t a suggestion that you should change your code, it’s simply there to make your work easier.
