...
<DashImage src="images/0DfmB09PD2DK-pvTz.png" alt="Release banner reading 'Announcing verified publishers for pub.dev' with a shield checkmark icon." />
...
<DashImage src="images/0Q24NUEox8eA10hVB.png" alt="Package list for the verified dart.dev publisher." caption="*Sample package list for a publisher*" />
