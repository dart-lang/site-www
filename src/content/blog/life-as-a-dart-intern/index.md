...
<DashImage src="images/06Ct-NyRGmYp_bmgp.png" alt="October 31 to-do list for variance work with many tasks crossed out and links to landed changes." caption="A typical to-do list" />
