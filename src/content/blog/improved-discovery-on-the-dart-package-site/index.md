...
<DashImage src="images/1Q9oEytibPnPy23qiSliyyQ.png" alt="Pub search results for json showing dart:convert above package results and marked with an sdk score badge." caption="Search hits in SDK core libraries are included among the results" />
...
<DashImage src="images/01rSptJGr3iaTKqvb.png" alt="The footer of the pub.dev website showing links to 'Dart language', 'Terms', 'Privacy', 'Help', and an RSS icon." />
