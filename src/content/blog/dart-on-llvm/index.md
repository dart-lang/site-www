...
<DashImage src="images/1DN03P0ofCSyHM6UwB42Nyg.png" alt="The Dart logo next to a metallic screw and a mechanical dragon (LLVM logo)." />
...
<DashImage src="images/1g6p0yM6fD_UD3rfsOWGQ-A.png" alt="The V8 engine logo next to a metallic screw and a mechanical dragon (LLVM logo)." />
...
<DashImage src="images/1VqmfjhoN9cMWH0vz37zU6A.jpeg" alt="A miniature model of a street with two toy garbage trucks and toy people, symbolizing garbage collection." />


## Architecture

<DashImage src="images/1pyM5bJo-_-i8Leum4yHPOQ.png" alt="A flowchart diagram of the Dart-on-LLVM compilation pipeline from Dart source to Dartino bytecodes, LLVM bitcode, assembler, and machine code." />
...
<DashImage src="images/1_B_KUgeFwaeUxC97GBIHPw.png" alt="A bar chart comparing DeltaBlue, Richards, and Mini-Splay benchmark results for LLVM AOT, Dart AOT, and DartVM JIT." />
...
<DashImage src="images/1uB5TngqsrAvvzu_fr8KCdg.png" alt="A bar chart comparing 'Hello World' total run time for LLVM AOT, Dart AOT, and DartVM JIT." />
...
<DashImage src="images/14bthU0tgek2j09dJuKn-aQ.png" alt="A pie chart showing that 88.4% of Dartino tests are passing." />
...
<DashImage src="images/1f_vtnoVYGfdXXqPUaGrOGw.png" alt="Pie chart of failing Dartino tests: Dart2JS at 40.1%, NoSuchMethod at 37.4%, Async at 15.4%, and smaller categories." />
