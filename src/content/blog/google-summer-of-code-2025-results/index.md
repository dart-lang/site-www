...
<DashImage src="images/1AWu8hJLDQzrZqv7BxH3byA.png" alt="The Google Summer of Code logo next to the Dart logo." />
...
<DashImage src="images/1kkXQy4enw3Pr2or4OVlLtw.gif" alt="An animation showing a custom iOS context menu in a Flutter app with items like 'Clear Text', 'Add Heart', and 'Uppercase'." />
...
<DashImage src="images/1mDFQO27q9khSRlpThxmcKw.png" alt="A diagram of the Pixel Prompt TUI framework architecture showing Input System, Render System, Component Tree, and Layout Engine." />
...
<DashImage src="images/185MHC2CehYCqjIIb_FDQIQ.png" alt="Terminal-based TODO list app built with Pixel Prompt." />


<DashImage src="images/1dTEQLLG7c6yfSbceRRc8pQ.png" alt="Terminal-based stopwatch app built with Pixel Prompt." />
...
<DashImage src="images/1iC6YYhsTRRz1Cps07v5NIg.png" alt="Java snippet calling ImageCapture.takePicture with output file options and saved and error callbacks." caption="Example Java snippet." />


<DashImage src="images/1Yalahis692k6SIKP4-N9JA.png" alt="Dart code snippet showing the translated Java code." caption="Example snippet Translation." />
...
<DashImage src="images/1dljRp-oi3pUFHHsdX6gYdQ.png" alt="A side-by-side comparison of TypeScript interface declarations and the generated Dart extension types." />
