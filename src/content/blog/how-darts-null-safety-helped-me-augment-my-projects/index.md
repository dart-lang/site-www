...
<DashImage src="images/1HlInW7jXUifJIGBK1YEQEw.jpeg" alt="Close-up of a code editor diff showing a Flutter SDK version constraint changed for null safety." />
...
<DashImage src="images/14-Gy0ZFl5Sgn2Cw-LLn2lA.png" alt="Diff from the null safety migration tool adding nullable markers to GlobalInfo, double, and HomeCountry fields." />
...
<DashImage src="images/1Cg1Ol3w_bIs6IIh734CBug.png" alt="Code snippet showing the migration tool automatically adding question marks to nullable properties." />


After the migration, some issues in the code became evident, **which is the best part**.

<DashImage src="images/17nfnF2UAdK6zoIhX4wMG9w.png" alt="Code snippet revealing an issue exposed after migrating to null safety." />
...
<DashImage src="images/1ahhIw3H8kp5WGMjDmrSzLg.png" alt="Analyzer error about passing nullable strings to a function expecting non-nullable strings." />
...
<DashImage src="images/1zHYqxaqdHWBdAILhoNMMrQ.png" alt="Dart HomeCountry class with non-nullable String fields and required constructor parameters." />
...
<DashImage src="images/1_uvcdlH2M7GvaW3tpgnTng.png" alt="IDE warning on list index access because a nullable list might be null before indexing." />
...
<DashImage src="images/1_a3XuVgmXlj9byIGPb-olg.png" alt="Code snippet showing a null check added to make the setState code valid." caption="The code for setState is now valid because list isn’t null." />
...
<DashImage src="images/1Nfm_rVVsyCGnCLqWE1pvbQ.png" alt="Code snippet showing the migration tool using late keywords for initialized variables." />
