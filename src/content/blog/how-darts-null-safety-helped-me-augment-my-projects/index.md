...
> If you aren’t aware of Flutter’s null safety feature, check out the [announcement of null safety]({{site.dart-blog}}/announcing-dart-null-safety-beta). If you want to fully understand null safety, check out [the Dart documentation for null safety](https://dart.dev/null-safety/understanding-null-safety).
