...
If you have ever called `add()`, `addAll()`, `map()`, or `toList()` to build a list or map, you might want to check out *collection if*, *collection for*, and *spreads*. Last year, Dart [added these features in version 2.3]({{site.dart-blog}}/announcing-dart-2-3-optimized-for-building-user-interfaces).
