...
* <a href='/effective-dart/design#do-document-if-your-class-supports-being-used-as-an-interface'>DO use class modifiers to control if your class can be used as an interface.</a>
