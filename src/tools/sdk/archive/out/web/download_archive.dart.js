...
C.y=H.n(s([]),t.s)
C.aa=H.n(s([]),t.t)
C.ad=H.n(s([0,0,32722,12287,65534,34815,65534,18431]),t.t)
C.af=H.n(s(["json"]),t.s)
...
C.ah=H.n(s(["macOS","Linux","Windows"]),t.s)
C.l=H.n(s(["Dart SDK"]),t.s)
C.L=new M.aW("x64",C.l)
C.ar=new M.aW("arm64",C.l)
C.B=new M.aW("ia32",C.l)
C.ag=H.n(s([C.L,C.ar,C.B]),t.r)
C.ap=new M.aW("x64",C.x)
C.aq=new M.aW("ARMv8 (ARM64)",C.l)
C.as=new M.aW("ARMv7",C.l)
C.a9=H.n(s([C.ap,C.B,C.aq,C.as]),t.r)
C.ae=H.n(s([C.L,C.B]),t.r)
C.J=new H.ao(3,{macOS:C.ag,Linux:C.a9,Windows:C.ae},C.ah,H.aw("ao<b,f<aW>>"))
C.ax=new H.ao(0,{},C.y,t.w)
C.aj=H.n(s(["macOS","Linux","Windows","ia32","x64","arm64","ARMv7","ARMv8 (ARM64)","Dart SDK"]),t.s)
C.m=new H.ao(9,{macOS:"macos",Linux:"linux",Windows:"windows",ia32:"ia32",x64:"x64",arm64:"arm64",ARMv7:"arm","ARMv8 (ARM64)":"arm64","Dart SDK":"dartsdk"},C.aj,t.w)
