...
{{site.alert.version-note}}
  The `dart pub outdated` command was introduced in Dart 2.10.
{{site.alert.end}}

{% comment %}
Dart version updated acording with /tools/dart-tool/ page
{% endcomment %}
...
1. Follow the recommendations of `dart pub outdated` for updating the packages.
...
1. **Run `dart pub outdated`** to confirm that you're using
...
{% include_relative _dart-pub-outdated-output.html %}
...
{% include_relative _dart-pub-outdated-output-columns.html %}
