const oldToNew = {
    ...
    'trailing-comma': '/language/collections#trailing-commas',
    'trailing-commas': '/language/collections#trailing-commas',
    'spread-operator': '/language/collections#spread-operator',
    ...
    'testing-functions-for-equality': '/language/functions#testing-functions-for-inequality',
    ...
    'conditional-expressions': '/language/operators#conditional-operators',
    'conditional-operators': '/language/operators#conditional-operators',
    ...
    'control-flow-statements': '/language/control-flow',
    'if-and-else': '/language/control-flow#if-and-else',
    'for-loops': '/language/control-flow#for-loops',
    'while-and-do-while': '/language/control-flow#while-and-do-while',
    'break-and-continue': '/language/control-flow#break-and-continue',
    'switch-and-case': '/language/control-flow#switch-and-case',
    ...
    'declaring-simple-enums': '/language/enum#declaring-simple-enums',
    'declaring-enhanced-enums': '/language/enum#declaring-enhanced-enums',
    'using-enums': '/language/enum#using-enums',
    ...
    'library-directive': '/language/libraries#the-library-directive',
    'the-library-directive': '/language/libraries#the-library-directive',
