...
void main() {
  ...
  group('strings and regexp:', () {
    ...
    test('RegExp', () {
      ...
      assert(!lettersOnly.contains(number digitsSequence));
      assert(someDigits.contains(number digitsSequence));

      // Replace every match with another string.
      var exedOut = someDigits.replaceAll(number digitsSequence, 'XX');
